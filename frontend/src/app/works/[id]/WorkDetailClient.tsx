...
import { ChevronLeft, Hash, Calendar, Layers, Terminal, Globe, ExternalLink, Code2 } from 'lucide-react';
...
export default function WorkDetailClient({ work, id }: { work: Work | null, id: string }) {
  useEffect(() => {
      ...
      <div className="max-w-[1440px] mx-auto px-6 md:px-12 lg:px-16 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
              ...
              <div className="glass-panel p-10 md:p-14 rounded-none relative overflow-hidden group">
                  ...
                  <div className="flex flex-col gap-12">
                    ...
                    <div className="prose prose-invert prose-lg max-w-none 
                       ...
                       prose-p:text-gray-400 prose-p:leading-[1.9] prose-p:text-sm
           ...
           <div className="lg:col-span-4 flex flex-col gap-6 lg:sticky lg:top-32">
              <div className="glass-panel p-10 rounded-none relative overflow-hidden text-left">
                 <div className="mb-0">
