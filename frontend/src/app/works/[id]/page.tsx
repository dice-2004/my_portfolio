                 ...
                 <div className="mb-12">
                    ...
                    <div className="space-y-10">
                       <div className="group">
                          ...
                          <p className="font-display font-black text-2xl group-hover:text-lime-green transition-colors text-white">{new Date(work.created_at).toLocaleDateString('ja-JP').split('/').join('.')}</p>
                       </div>
